      ...
      <div class="px-4 py-2 shadow-md flex items-center gap-4">
        <div class="flex items-center gap-2">
          ...
          <a href="https://zazuko.com" target="_blank" rel="noopener noreferer">
            <svg class="h-6" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.41421"
              viewBox="0 0 768 260" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <a href="https://github.com/zazuko/rdf-sketch" target="_blank" rel="noopener noreferer"
          title="Github repository">
          <svg class="w-4 h-4 opacity-70 hover:opacity-100" aria-hidden="true" viewBox="0 0 16 16" version="1.1"
